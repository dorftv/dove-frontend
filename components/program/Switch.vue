<template>
  <div class="rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 overflow-hidden p-2 lg:p-3 h-full flex flex-col items-center justify-center gap-2 lg:gap-3">
    <template v-if="selectedScene">
      <!-- Active indicator -->
      <div class="text-xs lg:text-sm text-gray-600 dark:text-gray-400 text-center">
